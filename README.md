...
| Package | What it is |
|---|---|
| `@waica/engine` | Core: game loop, Entity + Components, input actions, sprites, AABB solids |
| `@waica/behaviors` | Curated game-feel library: `PlatformerMovement`, `CameraFollow`, … |
| `@waica/archetype-platformer` | Opinionated platformer setup — playable from minute zero |
