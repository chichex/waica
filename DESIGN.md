...
- [ ] **Hito 1 restante**: wizard `create-waica`; monedas/enemigo/muerte/respawn en el arquetipo; props reactivas de Sprite; smoke test 3D del core unificado; migración a WebGPURenderer con fallback.
